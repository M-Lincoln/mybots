	...
	def Create_Brain(self):
		...
		for currentRow in range(3):
			for currentColumn in range(3,5):
				pyrosim.Send_Synapse( sourceNeuronName = currentRow , targetNeuronName= currentColumn+3 , weight=self.weights[currentRow][currentColumn])	#generate a synapse b/w the ith sensor neuron and the jth motor neuron between range -1,1)
