...
class SIMULATION:               #define a class, SIMULATION
    def __init__(self,directOrGUI, solutionID):         #defines the init constructor (AKA method) for the SIMULATION class
        ...
        self.robot = ROBOT(solutionID)    #creates a new SIMULATION attribute, and that attribute will hold an instance of the ROBOT class
